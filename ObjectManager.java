...
import rs.animable.Animable;
import rs.animable.Animable_Sub5;
import rs.animable.Model;
import rs.cache.OnDemandFetcher;
import rs.config.Flo;
...
public final class ObjectManager {
    ...
    private ArrayList<int[]> localObjectInfo = new ArrayList<>();
    ...
    public static void method188(WorldController worldController, int i, int j, int k, int l, Class11 class11, int ai[][][], int i1, int j1, int k1) {
        ...
        if (k == 10 || k == 11) {
            ...
            if (obj1 != null) {
                ...
                worldController.addInteractableEntity(i3, byte1, l2, i5, ((Animable) (obj1)), k4, k1, j5, j, i1);
            }
        ...
        if (k >= 12) {
            Object obj2;
            obj2 = class46.anInt781 == -1 && class46.childrenIDs == null ? class46.method578(k, i, l1, i2, j2, k2, -1) : new Animable_Sub5(j1, i, k, i2, j2, l1, k2, class46.anInt781, true);
            worldController.addInteractableEntity(i3, byte1, l2, 1, ((Animable) (obj2)), 1, k1, 0, j, i1);
            if (class46.aBoolean767)
                class11.method212(class46.aBoolean757, class46.anInt744, class46.anInt761, i1, j, i);
            return;
        }
        if (k == 0) {
            ...
            worldController.addWallObject(anIntArray152[i], ((Animable) (obj3)), i3, j, byte1, i1, null, l2, 0, k1);
            if (class46.aBoolean767)
        ...
        if (k == 1) {
            ...
            worldController.addWallObject(anIntArray140[i], ((Animable) (obj4)), i3, j, byte1, i1, null, l2, 0, k1);
            if (class46.aBoolean767)
                class11.method211(j, i, i1, k, class46.aBoolean757);
            return;
        }
        if (k == 2) {
            ...
            worldController.addWallObject(anIntArray152[i], ((Animable) (obj11)), i3, j, byte1, i1, ((Animable) (obj12)), l2, anIntArray152[j3], k1);
            if (class46.aBoolean767)
                class11.method211(j, i, i1, k, class46.aBoolean757);
            return;
        }
        if (k == 3) {
            ...
            worldController.addWallObject(anIntArray140[i], ((Animable) (obj5)), i3, j, byte1, i1, null, l2, 0, k1);
            if (class46.aBoolean767)
                class11.method211(j, i, i1, k, class46.aBoolean757);
            return;
        }
        if (k == 9) {
            ...
            worldController.addInteractableEntity(i3, byte1, l2, 1, ((Animable) (obj6)), 1, k1, 0, j, i1);
            if (class46.aBoolean767)
                class11.method212(class46.aBoolean757, class46.anInt744, class46.anInt761, i1, j, i);
            return;
        }
    ...
    public int[] getLocalObjectCoords(client client, int objectId) {
        if (localObjectInfo.size() > 0) {
            for (int i = 0; i <= localObjectInfo.size() - 1; i++) {
                int[] list = localObjectInfo.get(i);
                if (list != null && list[0] == objectId) {
                  /*  int coordX = client.getBaseX() + list[2];
                    int coordY = client.getBaseY() + list[1];
                        System.out.println("Returning "+list[0]+", "+coordX+":"+coordY);*/
                        return new int[]{list[1], list[2]};
                }
            }
        }
        return null;
    ...
    private void method175(int i, WorldController worldController, Class11 class11, int j, int k, int l, int i1, int j1) {
        ...
        if (localObjectInfo != null)
            localObjectInfo.add(localObjectInfo.size(), new int[]{i1, i, l});
       /* System.out.println("Length 1"+CUSTOM_OBJECTS.length);
        System.out.println("Length 2:"+CUSTOM_OBJECTS[0].length);
        System.out.println("Length 3:"+CUSTOM_OBJECTS[0][0]);*/
        if (k < anInt145)
            anInt145 = k;
        ...
        if (j == 10 || j == 11) {
            ...
            if (obj1 != null) {
                ...
                if (worldController.addInteractableEntity(l2, byte0, k2, l4, ((Animable) (obj1)), j4, k, i5, i, l) && class46.aBoolean779) {
                    Model model;
        ...
        if (j >= 12) {
            ...
            worldController.addInteractableEntity(l2, byte0, k2, 1, ((Animable) (obj2)), 1, k, 0, i, l);
        ...
        if (j == 0) {
            ...
            worldController.addWallObject(anIntArray152[j1], ((Animable) (obj3)), l2, i, byte0, l, null, k2, 0, k);
            if (j1 == 0) {
            ...
            if (class46.anInt775 != 16)
                worldController.moveWallDec(i, class46.anInt775, l, k);
            return;
        }
        if (j == 1) {
            Object obj4;
            ...
            worldController.addWallObject(anIntArray140[j1], ((Animable) (obj4)), l2, i, byte0, l, null, k2, 0, k);
            if (class46.aBoolean779)
                if (j1 == 0)
                    aByteArrayArrayArray134[k][l][i + 1] = 50;
                else if (j1 == 1)
        ...
        if (j == 2) {
            ...
            worldController.addWallObject(anIntArray152[j1], ((Animable) (obj11)), l2, i, byte0, l, ((Animable) (obj12)), k2, anIntArray152[i3], k);
            if (class46.aBoolean764)
                if (j1 == 0) {
                    anIntArrayArrayArray135[k][l][i] |= 0x249;
                    anIntArrayArrayArray135[k][l][i + 1] |= 0x492;
        ...
        if (j == 3) {
            ...
            worldController.addWallObject(anIntArray140[j1], ((Animable) (obj5)), l2, i, byte0, l, null, k2, 0, k);
            if (class46.aBoolean779)
                if (j1 == 0)
                    aByteArrayArrayArray134[k][l][i + 1] = 50;
                else if (j1 == 1)
        ...
        if (j == 9) {
            ...
            worldController.addInteractableEntity(l2, byte0, k2, 1, ((Animable) (obj6)), 1, k, 0, i, l);
            if (class46.aBoolean767 && class11 != null)
                class11.method212(class46.aBoolean757, class46.anInt744, class46.anInt761, l, i, j1);
            return;
        }
    ...
    public ArrayList<int[]> getLocalObjectInfo() {
