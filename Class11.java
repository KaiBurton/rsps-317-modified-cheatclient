...
final class Class11 {
    ...
    public void method210() {
        for (int i = 0; i < anInt292; i++) {
            for (int j = 0; j < anInt293; j++)
                anIntArrayArray294[i][j] = i == 0 || j == 0 || i == anInt292 - 1 || j == anInt293 - 1 ? 0xffffff : 0x1000000;
        }
    }
    ...
    public boolean method221(int i, int j, int k, int l, int i1, int j1, int k1) {
        int l1 = (j + j1) - 1;
        int i2 = (i + l) - 1;
        return k >= j && k <= l1 && k1 >= i && k1 <= i2 || k == j - 1 && k1 >= i && k1 <= i2 && (anIntArrayArray294[k - anInt290][k1 - anInt291] & 8) == 0 && (i1 & 8) == 0 || k == l1 + 1 && k1 >= i && k1 <= i2 && (anIntArrayArray294[k - anInt290][k1 - anInt291] & 0x80) == 0 && (i1 & 2) == 0 || k1 == i - 1 && k >= j && k <= l1 && (anIntArrayArray294[k - anInt290][k1 - anInt291] & 2) == 0 && (i1 & 4) == 0 || k1 == i2 + 1 && k >= j && k <= l1 && (anIntArrayArray294[k - anInt290][k1 - anInt291] & 0x20) == 0 && (i1 & 1) == 0;
    }
}
