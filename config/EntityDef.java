...
public final class EntityDef {
    ...
    public static EntityDef forID(int i) {
        for (int j = 0; j < 20; j++)
            if (cache[j].type == (long) i)
                return cache[j];
        System.out.println("Trying to be Entity ID: " + i);
        if (i > 3509)
            i = 528;
    ...
    public static void unpackConfig(StreamLoader streamLoader) {
        ...
        System.out.println("NPC COUNT: " + totalNPCs);
        int i = 2;
    ...
    public Model method160() {
        if (childrenIDs != null) {
            ...
            return entityDef == null ? null : entityDef.method160();
        }
        if (anIntArray73 == null)
            return null;
        boolean flag1 = false;
        for (int anAnIntArray73 : anIntArray73)
            if (!Model.method463(anAnIntArray73))
                flag1 = true;
    ...
    public Model method164(int j, int k, int ai[]) {
        ...
        if (model == null) {
            boolean flag = false;
            for (int anAnIntArray94 : anIntArray94)
                if (!Model.method463(anAnIntArray94))
                    flag = true;
