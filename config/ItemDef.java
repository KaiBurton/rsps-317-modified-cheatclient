...
public final class ItemDef {
    ...
    public static ItemDef forID(int i) {
        ...
        if (i < 7000)
            ...
            //10943 = 10$ scroll
            //10934 = 25$ scroll
        else if (i == 10943 || i == 10934)
            stream.currentOffset = streamIndices[2552];
        else if (i == 13854)
            stream.currentOffset = streamIndices[2912];
        else if(i == 15387)
            stream.currentOffset = streamIndices[3550];
        else if(i == 7956)
            stream.currentOffset = streamIndices[3549];
        else if(i == 18016)
            stream.currentOffset = streamIndices[6466];
        else
        ...
        if (itemDef.actions != null && itemDef.actions[1] == null)
            itemDef.actions[1] = "Wear";
        if (i == 10943 || i == 10934)
            itemDef.actions = new String[]{"Option1", "Option2", "Option3", "Option4", "Drop"};
        if (i == 995)
            itemDef.actions = new String[]{null, null, null, "Cash In", "Drop"};
        return itemDef;
    }
    ...
    public static Sprite getSprite(int i, int j, int k) {
        ...
        if (itemDef.certTemplateID != -1) {
            assert sprite != null;
            int l5 = sprite != null ? sprite.anInt1444 : 0;
