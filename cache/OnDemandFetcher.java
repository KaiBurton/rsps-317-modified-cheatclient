package rs.cache;// Decompiled by Jad v1.5.8f. Copyright 2001 Pavel Kouznetsov.
// Jad home page: http://www.kpdus.com/jad.html
// Decompiler options: packimports(3) 

import rs.NodeList;
import rs.NodeSubList;
import rs.client;
...
public final class OnDemandFetcher extends OnDemandFetcherParent
    ...
    public void start(StreamLoader streamLoader, client client1) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            int j = (abyte0 != null ? abyte0.length : 0) / 2;
        ...
        for (int k = 0; k < 4; k++) {
            ...
            int i1 = (abyte1 != null ? abyte1.length : 0) / 4;
        ...
        for (int k1 = 0; k1 < j1; k1++)
            if (k1 < (abyte2 != null ? abyte2.length : 0))
        ...
        j1 = (abyte2 != null ? abyte2.length : 0) / 7;
        ...
        j1 = (abyte2 != null ? abyte2.length : 0) / 2;
        ...
        stream2 = new Stream(abyte2);
        assert abyte2 != null;
        j1 = abyte2 != null ? abyte2.length : 0;
        ...
        try {
            if (socket == null) {
                ...
                if (l - openSocketTime < 4000L)
                    return;
                openSocketTime = l;
                // System.out.println("ondsrvprt: "+client.ondemandPort);
                // socket = clientInstance.openSocket(client.ondemandPort);
                socket = new Socket("localhost", client.ondemandPort);
