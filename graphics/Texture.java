    ...
    public static void method374(int i, int j, int k, int l, int i1, int j1, int k1, int l1,
        ...
        if (i <= j && i <= k) {
            ...
            if (j < k) {
                ...
                if (i != j && j3 < j2 || i == j && j3 > l2) {
                    k -= j;
                    j -= i;
                    for (i = anIntArray1472[i]; --j >= 0; i += width) {
                        method375(pixels, i, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
                        j1 += j3;
                        l += j2;
                        i2 += k3;
                        k1 += k2;
                    ...
                    while (--k >= 0) {
                        method375(pixels, i, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                        j1 += j3;
                        i1 += l2;
                        i2 += k3;
                        l1 += i3;
                ...
                j -= i;
                for (i = anIntArray1472[i]; --j >= 0; i += width) {
                    method375(pixels, i, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                    j1 += j3;
                    l += j2;
                    i2 += k3;
                    k1 += k2;
                ...
                while (--k >= 0) {
                    method375(pixels, i, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                    j1 += j3;
                    i1 += l2;
                    i2 += k3;
                    l1 += i3;
            ...
            if (i != k && j3 < j2 || i == k && l2 > j2) {
                j -= k;
                k -= i;
                for (i = anIntArray1472[i]; --k >= 0; i += width) {
                    method375(pixels, i, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    i1 += j3;
                    l += j2;
                    l1 += k3;
                    k1 += k2;
            ...
            k -= i;
            for (i = anIntArray1472[i]; --k >= 0; i += width) {
                method375(pixels, i, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                i1 += j3;
                l += j2;
                l1 += k3;
                k1 += k2;
        ...
        if (j <= k) {
            ...
            if (k < i) {
                ...
                if (j != k && j2 < l2 || j == k && j2 > j3) {
                    i -= k;
                    k -= j;
                    for (j = anIntArray1472[j]; --k >= 0; j += width) {
                        method375(pixels, j, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                        l += j2;
                        i1 += l2;
                        k1 += k2;
                        l1 += i3;
                    ...
                    while (--i >= 0) {
                        method375(pixels, j, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                        l += j2;
                        j1 += j3;
                        k1 += k2;
                        i2 += k3;
                ...
                k -= j;
                for (j = anIntArray1472[j]; --k >= 0; j += width) {
                    method375(pixels, j, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    l += j2;
                    i1 += l2;
                    k1 += k2;
                    l1 += i3;
                ...
                while (--i >= 0) {
                    method375(pixels, j, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
                    l += j2;
                    j1 += j3;
                    k1 += k2;
                    i2 += k3;
            ...
            if (j2 < l2) {
                k -= i;
                i -= j;
                for (j = anIntArray1472[j]; --i >= 0; j += width) {
                    method375(pixels, j, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                    j1 += j2;
                    i1 += l2;
                    i2 += k2;
                    l1 += i3;
            ...
            i -= j;
            for (j = anIntArray1472[j]; --i >= 0; j += width) {
                method375(pixels, j, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                j1 += j2;
                i1 += l2;
                i2 += k2;
                l1 += i3;
        ...
        if (i < j) {
            ...
            if (l2 < j3) {
                j -= i;
                i -= k;
                for (k = anIntArray1472[k]; --i >= 0; k += width) {
                    method375(pixels, k, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                    i1 += l2;
                    j1 += j3;
                    l1 += i3;
                    i2 += k3;
                ...
                while (--j >= 0) {
                    method375(pixels, k, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    i1 += l2;
                    l += j2;
                    l1 += i3;
                    k1 += k2;
            ...
            i -= k;
            for (k = anIntArray1472[k]; --i >= 0; k += width) {
                method375(pixels, k, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                i1 += l2;
                j1 += j3;
                l1 += i3;
                i2 += k3;
            ...
            while (--j >= 0) {
                method375(pixels, k, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                i1 += l2;
                l += j2;
                l1 += i3;
                k1 += k2;
        ...
        if (l2 < j3) {
            i -= j;
            j -= k;
            for (k = anIntArray1472[k]; --j >= 0; k += width) {
                method375(pixels, k, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                l += l2;
                j1 += j3;
                k1 += i3;
                i2 += k3;
        ...
        j -= k;
        for (k = anIntArray1472[k]; --j >= 0; k += width) {
            method375(pixels, k, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
            l += l2;
            j1 += j3;
            k1 += i3;
            i2 += k3;
