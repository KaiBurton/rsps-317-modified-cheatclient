...
public final class TextDrawingArea extends DrawingArea {
    ...
    public void method388(int i, String s, int j, int k, int l, int i1) {
        ...
        for (int k1 = 0; k1 < s.length(); k1++) {
            char c = s.charAt(k1);
            if (c != ' ')
                method392(aByteArrayArray1491[c], l + anIntArray1494[c], k + anIntArray1495[c] + (int) (Math.sin((double) k1 + (double) j) * d), anIntArray1492[c], anIntArray1493[c], i1);
            l += anIntArray1496[c];
        }
    ...
    public void method389(boolean flag1, int i, int j, String s, int k) {
        ...
        if (aBoolean1499)
            method339(k + (int) ((double) anInt1497 * 0.69999999999999996D), 0x800000, i - l, l);
    }
