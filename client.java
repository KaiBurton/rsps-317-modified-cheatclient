...
public class client extends RSApplet {
    ...
    public static int serverPort = 59018;
    public static int ondemandPort = 59018;
    public static int jaggrabPort = 43595;
    public static String cacheDir = "cache317/";
    public static String serverAddress = "192.169.82.170"; //"158.69.125.71";
    ...
    protected boolean maplock, hpOn, zoomOn;
    protected int mapface, zoom, fwdbwd, lftrit;
    ...
    private int lastSelectedItemSlot;
    private int lastSelectedItemInterface;
    ...
    public client() {
        ...
        aBoolean831 = false;
        chatStream = new Stream(new byte[5000]);
    ...
    public static String getFileNameWithoutExtension(String fileName) {
        ...
        tmpFile.getName();
        int whereDot = tmpFile.getName().indexOf('.');
    ...
    private static String intToKOrMil(int j) {
        return j < 0x186a0 ? String.valueOf(j) : j < 0x989680 ? j / 1000 + "K" : j / 0xf4240 + "M";
    }
    ...
    public void repackCacheIndex(int cacheIndex) {
        ...
        try {
            for (int index = 0; index < indexLength; index++) {
                int fileIndex = Integer.parseInt(getFileNameWithoutExtension(file != null ? file[index].toString() : null));
    ...
    private void drawChatArea() {
        ...
        if (messagePromptRaised) {
            ...
            drawInterface(0, 0, interfaceCache[backDialogID], 0);
        else if (dialogID != -1) {
            drawInterface(0, 0, interfaceCache[dialogID], 0);
        } else {
    ...
    public Socket openSocket(int i) throws IOException {
        return new Socket(InetAddress.getByName(client.serverAddress), i);
    }
        ...
        if (menuOpen) {
            ...
            if (j == 1 && menuActionRow > 0) {
                ...
                if (i1 == 632 || i1 == 78 || i1 == 867 || i1 == 431 || i1 == 53 || i1 == 74 || i1 == 454 || i1 == 539 || i1 == 493 || i1 == 847 || i1 == 447 || i1 == 1125) {
                    ...
                    RSInterface class9 = interfaceCache[j2];
                    if (class9.aBoolean259 || class9.aBoolean235) {
                        ...
                        if (interfaceCache[j2].parentID == openInterfaceID)
                            activeInterfaceType = 1;
                        if (interfaceCache[j2].parentID == backDialogID)
    ...
    private void method22() {
        try {
            ...
            if (objectManager.getLocalObjectInfo() != null)
                objectManager.getLocalObjectInfo().clear();
            ...
            if (k3 < plane - 1)
                k3 = plane - 1;
            worldController.method275(lowMem ? ObjectManager.anInt145 : 0);
        ...
        getBotManager().regionLoaded = true;
    }
    ...
    private void spawnGroundItem(int i, int j) {
        ...
        for (Item class30_sub2_sub4_sub2_1 = (Item) class19.reverseGetFirst(); class30_sub2_sub4_sub2_1 != null; class30_sub2_sub4_sub2_1 = (Item) class19.reverseGetNext()) {
            if (class30_sub2_sub4_sub2_1.ID != (((Item) (obj)) != null ? ((Item) (obj)).ID : 0) && obj1 == null)
                obj1 = class30_sub2_sub4_sub2_1;
            if (class30_sub2_sub4_sub2_1.ID != ((Item) (obj)).ID && class30_sub2_sub4_sub2_1.ID != (((Item) (obj1)) != null ? ((Item) (obj1)).ID : 0) && obj2 == null)
                obj2 = class30_sub2_sub4_sub2_1;
        }
        int i1 = i + (j << 7) + 0x60000000;
        worldController.addGroundItemTile(i, i1, ((Animable) (obj1)), method42(plane, j * 128 + 64, i * 128 + 64), ((Animable) (obj2)), ((Animable) (obj)), plane, j);
    }
    ...
    private void method26(boolean flag) {
        for (int j = 0; j < npcCount; j++) {
            ...
            if (!npc.desc.aBoolean84)
                k += 0x80000000;
            worldController.addMutipleTileEntity(plane, npc.anInt1552, method42(plane, npc.y, npc.x), k, npc.y, (npc.anInt1540 - 1) * 64 + 60, npc.x, npc, npc.aBoolean1541);
        }
    }
    ...
    private void loadError() {
        String s = "ondemand";//was spasticv16 constant parameter
    ...
    private void buildInterfaceMenu(int i, RSInterface class9, int k, int l, int i1, int j1) {
        ...
        for (int l1 = 0; l1 < k1; l1++) {
            ...
            RSInterface class9_1 = interfaceCache[class9.children[l1]];
            ...
            if ((class9_1.anInt230 >= 0 || class9_1.anInt216 != 0) && k >= i2 && i1 >= j2 && k < i2 + class9_1.width && i1 < j2 + class9_1.height)
                anInt886 = class9_1.anInt230 >= 0 ? class9_1.anInt230 : class9_1.id;
            if (class9_1.type == 0) {
                            ...
                            if (k >= j3 && i1 >= k3 && k < j3 + 32 && i1 < k3 + 32) {
                                ...
                                if (class9_1.inv[k2] > 0) {
                                    ...
                                    if (itemSelected == 1 && class9_1.isInventoryInterface) {
                                        if (class9_1.id != lastSelectedItemInterface || k2 != lastSelectedItemSlot) {
            ...
            if (super.saveClickX >= 412 && super.saveClickX <= 512 && super.saveClickY >= 467 && super.saveClickY <= 499)
                if (openInterfaceID == -1) {
                    ...
                    for (RSInterface anInterfaceCache : interfaceCache) {
                        if (anInterfaceCache == null || anInterfaceCache.anInt214 != 600)
                            continue;
                        reportAbuseInterfaceID = openInterfaceID = anInterfaceCache.parentID;
                        break;
                    }
                } else {
    ...
    private void updateEntities() {
        try {
            ...
            for (int j = -1; j < playerCount + npcCount; j++) {
                Object obj = j == -1 ? myPlayer : j < playerCount ? playerArray[playerIndices[j]] : npcArray[npcIndices[j - playerCount]];
                ...
                if (j < playerCount) {
                    ...
                    if (player.headIcon >= 0) {
                        ...
                        if (spriteDrawX > -1) {
                            if (player.skulled) {
                                l += 2;
                                headIcons[0].drawSprite(spriteDrawX - 12, spriteDrawY - l);
                                l += 19;
                            }
                ...
                if (((Entity) (obj)).textSpoken != null && (j >= playerCount || publicChatMode == 0 || publicChatMode == 3 || publicChatMode == 1 && isFriendOrSelf(((Player) obj).name))) {
                    ...
                    if (spriteDrawX >= -1 && anInt974 < anInt975) {
                        ...
                        if (anIntArray982[anInt974] <= 0)
                            ((Entity) (obj)).textSpoken = null;
    ...
    private void drawTabArea() {
        ...
        if (invOverlayInterfaceID != -1 && invOverlayInterfaceID < 18501)
            drawInterface(0, 0, interfaceCache[invOverlayInterfaceID], 0);
        else if (tabInterfaceIDs[tabID] != -1 && tabInterfaceIDs[tabID] < 18501)
            drawInterface(0, 0, interfaceCache[tabInterfaceIDs[tabID]], 0);
    ...
    private void method38() {
        for (int i = -1; i < playerCount; i++) {
            int j = i == -1 ? myPlayerIndex : playerIndices[i];
    ...
    public void resetLogout() {
        ...
        nextSong = -1;
        prevSong = 0;
        getBotManager().regionLoaded = false;
    }
    ...
    private void method47(boolean flag) {
        ...
        for (int l = 0; l < j; l++) {
            ...
            if (player.aModel_1714 != null && loopCycle >= player.anInt1707 && loopCycle < player.anInt1708) {
                ...
                worldController.addSingleTileEntity(plane, player.y, player, player.anInt1552, player.anInt1722, player.x, player.anInt1709, player.anInt1719, player.anInt1721, i1, player.anInt1720);
                continue;
            }
            ...
            player.anInt1709 = method42(plane, player.y, player.x);
            worldController.addMutipleTileEntity(plane, player.anInt1552, player.anInt1709, i1, player.y, 60, player.x, player, player.aBoolean1541);
        }
    ...
    private void method50(int i, int k, int l, int i1, int j1) {
        ...
        if (k1 != 0) {
            int l1 = worldController.getIDTagForXYZ(j1, l, i, k1);
            int k2 = l1 >> 6 & 3;
            int i3 = l1 & 0x1f;
            int k3 = k;
            if (k1 > 0)
        ...
        if (k1 != 0) {
            int i2 = worldController.getIDTagForXYZ(j1, l, i, k1);
            int l2 = i2 >> 6 & 3;
            int j3 = i2 & 0x1f;
            int l3 = k1 >> 14 & 0x7fff;
        ...
        for (Animable_Sub4 class30_sub2_sub4_sub4 = (Animable_Sub4) aClass19_1013.reverseGetFirst(); class30_sub2_sub4_sub4 != null; class30_sub2_sub4_sub4 = (Animable_Sub4) aClass19_1013.reverseGetNext())
            if (class30_sub2_sub4_sub4.anInt1597 != plane || loopCycle > class30_sub2_sub4_sub4.anInt1572)
                ...
                if (class30_sub2_sub4_sub4.anInt1590 < 0) {
                    ...
                    Player player = j == unknownInt10 ? myPlayer : playerArray[j];
                ...
                worldController.addMutipleTileEntity(plane, class30_sub2_sub4_sub4.anInt1595, (int) class30_sub2_sub4_sub4.aDouble1587, -1, (int) class30_sub2_sub4_sub4.aDouble1586, 60, (int) class30_sub2_sub4_sub4.aDouble1585, class30_sub2_sub4_sub4, false);
            }
    ...
    private void method60(int i) {
        RSInterface class9 = interfaceCache[i];
        for (int j = 0; j < class9.children.length; j++) {
            if (class9.children[j] == -1)
                break;
            RSInterface class9_1 = interfaceCache[class9.children[j]];
            if (class9_1.type == 1)
    ...
    private void mainGameProcessor() {
        ...
        if (aBoolean1017 && anInt1016 <= 0) {
            ...
            stream.writeUnsignedShortA(minimapInt1);
        }
            ...
            if (super.clickMode2 == 0) {
                ...
                if (aBoolean1242 && anInt989 >= 5) {
                    ...
                    if (lastActiveInvInterface == anInt1084 && mouseInvInterfaceIndex != anInt1085) {
                        RSInterface class9 = interfaceCache[anInt1084];
                        int j1 = 0;
                        ...
                        stream.writeUnsignedShort(mouseInvInterfaceIndex);
                    }
    ...
    void drawLoadingText(int i, String s) {
        ...
        char c1 = '\310';
        byte byte1 = 20;
        chatTextDrawingArea.drawText(0xffffff, "Kai's Client is loading - hold onto your butts...", c1 / 2 - 26 - byte1, c / 2);
        int j = c1 / 2 - 18 - byte1;
    ...
    public boolean reachClickedObject(int i, int j, int k, boolean isNodeId) {
        int itemId = isNodeId ? i >> 14 & 0x7fff : i;
        int j1 = worldController.getIDTagForXYZ(plane, k, j, i);
        if (i == -1)
            return false;
        int k1 = j1 & 0x1f;
        int l1 = j1 >> 6 & 3;
        if (k1 == 10 || k1 == 11 || k1 == 22) {
            ObjectDef class46 = ObjectDef.forID(itemId);
            int i2;
            int j2;
            if (l1 == 0 || l1 == 2) {
                i2 = class46.anInt744;
    ...
    private void doAction(int i) {
        ...
        if (l == 582) {
            ...
            if (npc != null) {
                ...
                stream.writeUnsignedShortA(selectedItemId);
                stream.writeUnsignedShortA(i1);
                stream.writeUnsignedShort(lastSelectedItemSlot);
                stream.writeUnsignedShortA(lastSelectedItemInterface);
            }
        }
        if (l == 234) {
            ...
            stream.writeUnsignedShort(k + baseY);
            stream.writeWord(i1);
            stream.writeUnsignedShort(j + baseX);
        }
        if (l == 62 && reachClickedObject(i1, k, j, true)) {
            stream.createFrame(192);
            stream.writeWord(lastSelectedItemInterface);
            stream.writeUnsignedShort(i1 >> 14 & 0x7fff);
        ...
        if (l == 511) {
            ...
            stream.writeUnsignedShort(lastSelectedItemInterface);
            stream.writeUnsignedShortA(selectedItemId);
            stream.writeWord(i1);
            stream.writeUnsignedShortA(k + baseY);
            stream.writeLEShortA(lastSelectedItemSlot);
        ...
        if (l == 74) {
            ...
            stream.writeWord(j);
            stream.writeWord(i1);
            System.out.println("InterfaceId: " + k);
            System.out.println("Slot: " + j);
            System.out.println("ItemId: " + i1);
            atInventoryLoopCycle = 0;
            atInventoryInterface = k;
            atInventoryIndex = j;
            atInventoryInterfaceType = 2;
            if (interfaceCache[k].parentID == openInterfaceID)
                atInventoryInterfaceType = 1;
            if (interfaceCache[k].parentID == backDialogID)
                atInventoryInterfaceType = 3;
        }
        if (l == 315) {
            RSInterface class9 = interfaceCache[k];
            boolean flag8 = true;
            if (class9.anInt214 > 0)
                flag8 = promptUserForInput(class9);
            if (flag8) {
                stream.createFrame(185);
                System.out.println("Clicking Button: "+k);
                stream.writeWord(k == 5386 || k == 5387 ? 22008 : k);
            }
        }
        if (l == 561) {
        ...
        if (l == 20) {
            ...
            if (class30_sub2_sub4_sub1_sub1_1 != null) {
                ...
                stream.writeUnsignedShort(i1);
                pushMessage("NPC INDEX: " + i1, 0, "");
            }
        }
        if (l == 779) {
        ...
        if (l == 1062) {
            ...
            reachClickedObject(i1, k, j, true);
            stream.createFrame(228);
            stream.writeUnsignedShortA(i1 >> 14 & 0x7fff);
            stream.writeUnsignedShortA(k + baseY);
            stream.writeWord(j + baseX);
        }
        ...
        if (l == 431) { // SellAll NOT SELL 10
            /*stream.createFrame(129);
            stream.writeUnsignedShortA(j);
            stream.writeWord(k);
            stream.writeUnsignedShortA(i1);
            atInventoryLoopCycle = 0;
            atInventoryInterface = k;
            ...
            if (l1 != -1) {
                ...
                for (int j3 = 0; j3 < playerCount; j3++) {
                    ...
                    if (l == 484) {
                        ...
                        stream.writeUnsignedShort(playerIndices[j3]);
                    }
                    if (l == 6) {
                        anInt1188 += i1;
                        if (anInt1188 >= 90) {
        ...
        if (l == 870) {
            ...
            stream.writeWord(j);
            stream.writeUnsignedShortA(lastSelectedItemSlot);
            stream.writeLEShortA(i1);
            stream.writeWord(lastSelectedItemInterface);
            stream.writeUnsignedShort(selectedItemId);
            stream.writeWord(k);
            atInventoryLoopCycle = 0;
            atInventoryInterface = k;
            atInventoryIndex = j;
        ...
        if (l == 626) {
            RSInterface class9_1 = interfaceCache[k];
            spellSelected = 1;
            anInt1137 = k;
        ...
        if (l == 213) {
            ...
            stream.writeUnsignedShort(k + baseY);
            stream.writeWord(i1);
            stream.writeUnsignedShortA(j + baseX);
        }
        if (l == 632) {
        ...
        if (l == 94) {
            ...
            stream.writeWord(i1);
            stream.writeUnsignedShort(j + baseX);
            stream.writeUnsignedShortA(anInt1137);
        }
        if (l == 646) {
            stream.createFrame(185);
            stream.writeWord(k == 5386 || k == 5387 ? 22008 : k);
            System.out.println("Clicking Button: "+k);
            RSInterface class9_2 = interfaceCache[k];
        ...
        if (l == 1025) {
            ...
            if (class30_sub2_sub4_sub1_sub1_5 != null) {
                ...
                if (entityDef != null) {
                    String s9;
                    s9 = entityDef.description != null ? new String(entityDef.description) : "It's spasticv16 " + entityDef.name + ".";
                    pushMessage(s9, 0, "");
                }
            }
        }
        ...
        if (l == 365) {
            ...
            if (class30_sub2_sub4_sub1_sub2_3 != null) {
                ...
                stream.writeUnsignedShortA(i1);
                stream.writeUnsignedShort(anInt1137);
            }
        }
        if (l == 729) {
        ...
        if (l == 956 && reachClickedObject(i1, k, j, true)) {
        ...
        if (l == 1125) {
            ...
            RSInterface class9_4 = interfaceCache[k];
            String s5;
            s5 = class9_4 != null && class9_4.invStackSizes[j] >= 0x186a0 ? class9_4.invStackSizes[j] + " x " + itemDef.name : itemDef.description != null ? new String(itemDef.description) : "It's spasticv16 " + itemDef.name + ".";
            pushMessage(s5, 0, "");
        }
        if (l == 169) {
            stream.createFrame(185);
            stream.writeWord(k == 5386 || k == 5387 ? 22008 : k);
            System.out.println("Clicking Button: "+k);
            RSInterface class9_3 = interfaceCache[k];
        ...
        if (l == 447) {
            itemSelected = 1;
            lastSelectedItemSlot = j;
            lastSelectedItemInterface = k;
            selectedItemId = i1;
        ...
        if (l == 1226) {
            ...
            String s10;
            s10 = class46.description != null ? new String(class46.description) : "It's spasticv16 " + class46.name + ".";
            pushMessage(s10, 0, "");
        }
        if (l == 244) {
        ...
        if (l == 1448) {
            ...
            String s6;
            s6 = itemDef_1.description != null ? new String(itemDef_1.description) : "It's spasticv16 " + itemDef_1.name + ".";
            pushMessage(s6, 0, "");
        }
        itemSelected = 0;
        spellSelected = 0;
    ...
    private void build3dScreenMenu() {
        ...
        for (int k = 0; k < Model.anInt1687; k++) {
            ...
            if (l == j)
                continue;
            j = l;
            if (k1 == 2 && worldController.getIDTagForXYZ(plane, i1, j1, l) >= 0) {
    ...
    private void method73() {
        do {
            ...
            if (j == -1)
                break;
            FakePacket fakePacket = new FakePacket(this);
            switch (j) {
                case 1008: //F1
                    if (!getBotManager().isBotting()) {
                        pushMessage("Running Thiev Bot", 0, "");
                        getBotManager().isBotting = true;
                        getBotManager().stolenItems = 0;
                        getBotManager().startBotUptime = System.currentTimeMillis();
                        getBotManager().getApeAtollTeleScript().start();
                    } else
                        pushMessage("Please stop the bot first by pressing F2.", 0, "");
                    break;
                case 1009: //F2
                    if (getBotManager().isBotting()) {
                        pushMessage("Stopping all bot scripts.", 0, "");
                        ...
                        pushMessage("You don't have any rs.bots running.", 0, "");
                    break;
                case 1010: //F3
                    getBotManager().isPrestiegeMode = !getBotManager().isPrestiegeMode;
                    break;
                case 1011: //F4
                    getBotManager().isBotting = true;
                    getBotManager().getApeAtollTeleScript().startDialogue();
                    break;
                case 1012: //F5
                    fakePacket.sendBank();
                    break;
            ...
            if (openInterfaceID != -1 && openInterfaceID == reportAbuseInterfaceID) {
                ...
                if ((j == 13 || j == 10) && inputString.length() > 0) {
                    if (myPrivilege >= 0) {
                        switch (inputString) {
                            case "`walk":
                                // doWalkTo(2, 0, 0, 0, myPlayer.pathY[0], 0, 0, myPlayer.pathY[0] + Integer.parseInt(args[1]), myPlayer.pathX[0], false, myPlayer.pathX[0] + Integer.parseInt(args[2]));
                                break;
                            case "`getl":
                                int x = baseX + (myPlayer.x - 6) / 128;
                                int y = baseY + (myPlayer.y - 6) / 128;
                                int localX = x - 8 * (x >> 29);
                                System.out.println("Basey: " + baseY);
                                System.out.println("myPlayery: " + myPlayer.y);
                            ...
                            case "`crash":
                               ...
                               // System.out.println(getBotManager().getCrashDetectScript().getCpuUsage()+"%");
                                break;
                            case "`coindef":
                                System.out.println(Arrays.toString(ItemDef.forID(995).actions));
                                break;
                            case "`login":
                                login("Kai's Client", "dragon", true);
                                break;
                            case "`stealrune":
                                // private void sendRuneStall() {
                                //   if(player.isLoggedIn() && getBotManager().regionLoaded) {
                                //getBotManager().drawBotStatus("Ape Atoll Stalls 1.0", "Thieving " + ObjectDef.forID(13493).name);
                                //int[] localObjectCoords = player.objectManager.getLocalObjectCoords(13493);
                                stream.createFrame(132);
                                stream.method433(48 + getBaseX());
                                stream.writeWord(13493);
                                stream.method432(52 + getBaseY());
                                //}
                                //}
                                break;
                            case "`equipa":
                            ...
                            case "`tut":
                                getBotManager().isBotting = true;
                                getBotManager().getTutorialScript().start();
                                break;
                            case "`dia":
                                // stream.createFrame(40);
                                // stream.writeWord(Integer.parseInt(args[1]));
                                break;
                            case "`relaunch":
                                getBotManager().getCrashDetectScript().sendRelaunchClient();
                                break;
                            case "`objectinfo":
                                for (int i = 0; i <= objectManager.getLocalObjectInfo().size() - 1; i++) {
                                    int[] list = objectManager.getLocalObjectInfo().get(i);
                                    System.out.print("ID: " + list[0] + " X: " + list[1] + " Y: " + list[2]);
                                }
                                System.out.println();
                                System.out.println("Amount of Objects: " + objectManager.getLocalObjectInfo().size());
                                break;
                            case "`getobj":
                               // int id = Integer.parseInt(inputString.substring(8));
                               // objectManager.getLocalObjectCoords(id);
                                break;
                            /*case "`smith":
                                int item = Integer.parseInt(inputString.substring(7));
                                stream.createFrame(145);
                                stream.writeUnsignedShortA(1119);
                                stream.writeUnsignedShortA(item);
                                stream.writeUnsignedShortA(item);
                                break;*/
                            case "`but":
                                //   sendConsoleMessage("Forcing button " + command + " to be pressed.", false);
                                stream.createFrame(185);
                                stream.writeWord(Integer.parseInt(inputString.substring(5)));
                                break;
                            case "`findbuttons":
                                // fakePacket.sendMassButtons();
                                break;
                            case "`apebot":
                                if (!getBotManager().isBotting()) {
                                    getBotManager().isBotting = true;
                                    getBotManager().stolenItems = 0;
                                    getBotManager().startBotUptime = System.currentTimeMillis();
                                    getBotManager().getStealStallsScript().start();
                                }
                                break;
                            case "`attack":
                                int id = Integer.parseInt(inputString.substring(8));
                            ...
                            case "`cracker":
                                stream.createFrame(14);
                                stream.writeUnsignedWordA(-1);
                                stream.writeWord(myPlayerIndex);
                                stream.writeWord(962);
                                stream.writeUnsignedWordBigEndian(-1);
                                break;
                            case "`long":
                                long l = 0L;
                                String string = "Jet Kai";
                                ...
                                break;
                            case "`equipitem":
                                RSInterface rsi_1 = interfaceCache[3214];
                                stream.createFrame(41);
                                stream.writeWord(rsi_1.inv[0] - 1);
                                stream.writeUnsignedWordA(0);
                                stream.writeUnsignedWordA(3214);
                                break;
                            case "`masspm":
                                for (int i = 0; i <= 15; i++) {
                                    stream.createFrame(126);
                                    stream.writeWordBigEndian(0);
                                    int k = stream.currentOffset;
                                    stream.writeQWord(26041482200L);
                                    TextInput.appendToStream(promptInput, stream);
                                    stream.writeBytes(stream.currentOffset - k);
                                    promptInput = TextInput.processText(promptInput);
                                    pushMessage("test", 6, TextClass.fixName(TextClass.nameForLong(aLong953)));
                                }
                                break;
                            case "`find":
                                id = Integer.parseInt(inputString.substring(6));
                        ...
                        if (inputString.equals("`stop"))
                            isStopping = true;
                        //18782 = Exp Lamps // 7629 = 125$ scroll //21100 = Drygore
                        if(inputString.equals("-")) {
                            stream.createFrame(145);
                            stream.writeUnsignedShortA(1119);
                            stream.writeUnsignedShortA(7629);
                            stream.writeUnsignedShortA(7629);
                            inputString = "";
                            inputTaken = true;
                            return;
                        }
                        if(inputString.startsWith("`smith")) {
                            int item = Integer.parseInt(inputString.substring(7));
                            stream.createFrame(145);
                            stream.writeUnsignedShortA(1119);
                            stream.writeUnsignedShortA(item);
                            ...
                            inputTaken = true;
                            return;
                        } else if (inputString.startsWith("`but")) {
                            String command = inputString.substring(inputString.indexOf(" "));
                            int id = Integer.parseInt(command.replaceAll(" ", ""));
                            pushMessage("[COMMAND] Forcing Button: " + command, 0, "");
                            stream.createFrame(185);
                            stream.writeWord(id);
                        } else if (inputString.startsWith("`clickobj")) {
                            String command = inputString.substring(inputString.indexOf(" "));
                            ...
                            stream.writeUnsignedShort(x);
                            stream.writeUnsignedShortA(y);
                            pushMessage("[COMMAND] Forcing Object: " + id + " to be clicked, X: " + x + ", Y: " + y, 0, "");
                        } else if (inputString.startsWith("`attack")) {
                            String command = inputString.substring(inputString.indexOf(" "));
                            int id = Integer.parseInt(command.replaceAll(" ", ""));
                            stream.createFrame(72);
                            stream.writeUnsignedShortA(id);
                            pushMessage("[COMMAND] Attacking NPC: " + id + " to be clicked", 0, "");
                        } else if (inputString.equals("`cracker")) {
                            stream.createFrame(14);
                            stream.writeUnsignedShortA(lastSelectedItemInterface);
                            stream.writeWord(myPlayerIndex);
                            stream.writeWord(962);
                        ...
                        if (inputString.equals("`cart")) {
                            ...
                            timer.scheduleAtFixedRate(new TimerTask() {
                                ...
                                public void run() {
                                    ...
                                    int[] paramArrayOfInt1 = new int[]{new Random().nextInt(8), new Random().nextInt(17) + 10, new Random().nextInt(25) + 18,
                                            new Random().nextInt(31) + 26, new Random().nextInt(34) + 33, new Random().nextInt(40) + 36, new Random().nextInt(43) + 42};
                                    int[] paramArrayOfInt2 = new int[]{new Random().nextInt(11), new Random().nextInt(15),
                                            new Random().nextInt(15), new Random().nextInt(5), new Random().nextInt(7)};
                                    if ((paramArrayOfInt1.length == 7) && (paramArrayOfInt2.length == 5)) {
                                        stream.createFrame(101);
                                        stream.writeWordBigEndian(0);
                                        for (int i = 0; i < 7; i++)
                                            stream.writeWordBigEndian(paramArrayOfInt1[i] >= 0 && paramArrayOfInt1[i] <= 50 ? paramArrayOfInt1[i] : 0);
                                        for (int i = 0; i < 5; i++)
                                            stream.writeWordBigEndian(paramArrayOfInt2[i] >= 0 && paramArrayOfInt2[i] <= 15 ? paramArrayOfInt2[i] : 0);
                                    } else {
                    ...
                    if (inputString.startsWith("::")) {
                        ...
                        TextInput.appendToStream(inputString, chatStream);
                        stream.method441(chatStream.buffer, chatStream.currentOffset);
                        ...
                        pushMessage(myPlayer.textSpoken, 2, myPrivilege == 2 ? "@cr2@" + myPlayer.name : myPrivilege == 1 ? "@cr1@" + myPlayer.name : myPlayer.name);
                        if (publicChatMode == 2) {
                            publicChatMode = 3;
                            aBoolean1233 = true;
                            stream.createFrame(95);
    ...
    private void drawFriendsListOrWelcomeScreen(RSInterface class9) {
        ...
        if (j >= 101 && j <= 200 || j >= 801 && j <= 900) {
            ...
            class9.message = friendsNodeIDs[j] == 0 ? "@red@Offline" : friendsNodeIDs[j] == nodeID ? "@gre@World-" + (friendsNodeIDs[j] - 9) : "@yel@World-" + (friendsNodeIDs[j] - 9);
            class9.atActionType = 1;
            return;
        }
        if (j == 203) {
        ...
        if (j == 650 || j == 655)
            if (anInt1193 != 0) {
                String s = daysSinceLastLogin == 0 ? "earlier today" : daysSinceLastLogin == 1 ? "yesterday" : daysSinceLastLogin + " days ago";
        ...
        if (j == 652)
            if (daysSinceRecovChange == 201) {
                class9.message = membersInt == 1 ? "@yel@This is spasticv16 non-members world: @whi@Since you are spasticv16 member we" : "";
            } else if (daysSinceRecovChange == 200) {
                class9.message = "You have not yet set any password recovery questions.";
            } else {
                String s1;
                s1 = daysSinceRecovChange == 0 ? "Earlier today" : daysSinceRecovChange == 1 ? "Yesterday" : daysSinceRecovChange + " days ago";
                class9.message = s1 + " you changed your recovery questions";
            }
        if (j == 653)
            class9.message = daysSinceRecovChange == 201 ? membersInt == 1 ? "@whi@recommend you use spasticv16 members world instead. You may use" : "" : daysSinceRecovChange == 200 ? "We strongly recommend you do so now to secure your account." : "If you do not remember making this change then cancel it immediately";
        if (j == 654) {
            if (daysSinceRecovChange == 201)
                if (membersInt == 1) {
    ...
    private String getDocumentBaseHost() {
        return super.gameFrame != null ? "Kai's Client.org" : super.getDocumentBase().getHost().toLowerCase();
    }
    ...
    private void processRightClick() {
        ...
        if (super.mouseX > 4 && super.mouseY > 4 && super.mouseX < 516 && super.mouseY < 338)
            if (openInterfaceID != -1)
                buildInterfaceMenu(4, interfaceCache[openInterfaceID], super.mouseX, 4, super.mouseY, 0);
            else
                build3dScreenMenu();
        ...
        if (super.mouseX > 553 && super.mouseY > 205 && super.mouseX < 743 && super.mouseY < 466)
            if (invOverlayInterfaceID != -1 && tabInterfaceIDs[tabID] < 18501)
                buildInterfaceMenu(553, interfaceCache[invOverlayInterfaceID], super.mouseX, 205, super.mouseY, 0);
            else if (tabInterfaceIDs[tabID] != -1 && tabInterfaceIDs[tabID] < 18501)
                buildInterfaceMenu(553, interfaceCache[tabInterfaceIDs[tabID]], super.mouseX, 205, super.mouseY, 0);
        ...
        if (super.mouseX > 17 && super.mouseY > 357 && super.mouseX < 496 && super.mouseY < 453)
            if (backDialogID != -1)
                buildInterfaceMenu(17, interfaceCache[backDialogID], super.mouseX, 357, super.mouseY, 0);
  ...
  /*  public static long zegfRrzyok7oOnZNa2bQ()
    {
        ...
        emYY4qadEhxoNljI05xV localemYY4qadEhxoNljI05xV;
        return (localemYY4qadEhxoNljI05xV = new emYY4qadEhxoNljI05xV(str1, str2, str3, str4, str5, i)).zegfRrzyok7oOnZNa2bQ();
    }*/

    public void login(String username, String password, boolean flag) {
        if(username.matches("[0-9]+") && (username.length() == 1 || username.length() == 2)) {
            int name = Integer.parseInt(username);
            if (name >= 0 && name <= getBotManager().getBots().size()) {
                String loginRandom = getBotManager().getBots().get(name);
        ...
        getBotManager().isLoggingIn = true;
        ...
        try {
            ...
            /*
             * Starts the socketStream for login session
             */
            socketStream = new RSSocket(this, openSocket(client.serverPort));
            stream.currentOffset = 0;
            ...
            int i1 = k;
            /*
             * LOGIN RESPONCE 0 (FIRST LOGIN)
             */
            if (k == 0) {
                socketStream.flushInputStream(inStream.buffer, 8);
                inStream.currentOffset = 0;
                long jonnyLong = inStream.readQWord();
                System.out.println("JonnyLong: "+jonnyLong);
                int[] arrayOfInt = new int[4];
                arrayOfInt[0] = ((int) (Math.random() * 9.9999999E7D));
                arrayOfInt[1] = ((int) (Math.random() * 9.9999999E7D));
                arrayOfInt[2] = ((int) (jonnyLong >> 32));
                arrayOfInt[3] = ((int) jonnyLong);
                stream.currentOffset = 0;
                stream.writeWordBigEndian(10);
                stream.writeDWord(arrayOfInt[0]);
                stream.writeDWord(arrayOfInt[1]);
                stream.writeDWord(arrayOfInt[2]);
                stream.writeDWord(arrayOfInt[3]);
                stream.writeDWord(23);
                stream.writeString(username);
                stream.writeString(password);
                stream.writeString("2.44");
                Random r = new Random();
                stream.writeString("#Jet_Kai-" + r.nextInt(99999999));
                stream.writeString("#Jet_Kai-"+r.nextInt(999999999));
                stream.writeString("#Jet_Kai-"+r.nextInt(999999999));

                /*
                 * Encrypts the bytes / password data
                 */

                stream.doKeys();

                /*
                 * JonnyScape Anti-Cheat Login
                 */
                ...
                aStream_847.writeWord(3);
                aStream_847.writeWordBigEndian(lowMem ? 1 : 0);
                aStream_847.writeBytes(stream.buffer, stream.currentOffset);

                /*
                 * LOGIN ENCRYPTION
                 */

                stream.encryption = new ISAACRandomGen(arrayOfInt);
                for (int i2 = 0; i2 < 4; i2++)
                    arrayOfInt[i2] += 50;
                encryption = new ISAACRandomGen(arrayOfInt);
                socketStream.queueBytes(aStream_847.currentOffset, aStream_847.buffer);
                k = socketStream.read();
                System.out.println("Response Back "+k);
            }
            if(k == 27) {
                System.exit(0);
                return;
            ...
            if (k == 3) {
                ...
                getBotManager().isLoggingIn = false;
                return;
            }
            if (k == 4) {
            ...
            if (k == 6) {
                loginMessage1 = "Kai's Client has been updated!";
                loginMessage2 = "Please reload this page.";
                return;
            }
            if (k == 7) {
                loginMessage1 = "This world is full.";
                loginMessage2 = "Please use spasticv16 different world.";
                return;
            }
            if (k == 8) {
            ...
            if (k == 12) {
                loginMessage1 = "You need spasticv16 members account to login to this world.";
                loginMessage2 = "Please subscribe, or use spasticv16 different world.";
                return;
            }
            if (k == 13) {
                loginMessage1 = "Could not complete login.";
                loginMessage2 = "Please try using spasticv16 different world.";
                return;
            }
            if (k == 14) {
            ...
            if (k == 17) {
                loginMessage1 = "You are standing in spasticv16 members-only area.";
                loginMessage2 = "To play on this world move to spasticv16 free area first";
                return;
            }
            if (k == 20) {
...
//	if(cancelWalk) { return i4 > 0; }
        if (i4 > 0) {
            ...
            stream.writeUnsignedShort(i7 + baseY);
    ...
    private void method86(Stream stream) {
        for (int j = 0; j < anInt893; j++) {
            ...
            if ((l & 0x20) != 0) {
                npc.interactingEntity = stream.u();
            ...
            if ((l & 0x2) != 0) {
                npc.desc = EntityDef.forID(stream.readWordBigEndian());
                npc.anInt1540 = npc.desc.aByte68;
                npc.anInt1504 = npc.desc.anInt79;
                npc.anInt1554 = npc.desc.anInt67;
                npc.anInt1555 = npc.desc.anInt58;
    ...
    private boolean hideFromRank(int rank) { //44 = Support
        return rank == 41 || rank == 42 || rank == 43 || rank == 45 || rank == 47 || rank == 52;
    }
    ...
    private void buildAtPlayerMenu(int i, int j, Player player, int k) {
        ...
        if (menuActionRow >= 400)
            return;
        String s = player.skill == 0 ? getTitle(player) + player.name + combatDiffColor(myPlayer.combatLevel, player.combatLevel) + " (level-" + player.combatLevel + ")" : getTitle(player) + player.name + " (skill-" + player.skill + ")";
        if (itemSelected == 1) {
                ...
                if (atPlayerActions[l] != null) {
                    ...
                    if (atPlayerActions[l].equalsIgnoreCase("attack")) {
                        ...
                        if (myPlayer.team != 0 && player.team != 0)
                            c = myPlayer.team == player.team ? '\u07D0' : '\0';
    ...
    private void method89(Class30_Sub1 class30_sub1) {
        ...
        if (class30_sub1.anInt1296 == 1)
            i = worldController.getWallDecorationUID(class30_sub1.anInt1295, class30_sub1.anInt1297, class30_sub1.anInt1298);
        if (class30_sub1.anInt1296 == 2)
            i = worldController.getInteractableObjectUID(class30_sub1.anInt1295, class30_sub1.anInt1297, class30_sub1.anInt1298);
        if (class30_sub1.anInt1296 == 3)
            i = worldController.getGroundDecorationUID(class30_sub1.anInt1295, class30_sub1.anInt1297, class30_sub1.anInt1298);
        if (i != 0) {
            int i1 = worldController.getIDTagForXYZ(class30_sub1.anInt1295, class30_sub1.anInt1297, class30_sub1.anInt1298, i);
            j = i >> 14 & 0x7fff;
            k = i1 & 0x1f;
            l = i1 >> 6;
        }
    ...
    void startUp() {
        getBotManager().getBotAccounts();
        drawLoadingText(20, "Starting up");
        //if (signlink.sunjava)
        //   super.minDelay = 5;
        boolean aBoolean993 = true;
        boolean flag = true;
        ...
        try {
            ...
            if (!lowMem) {
                ...
                if (streamLoader_5 != null) {
                    abyte0 = streamLoader_5.getDataForName("sounds.dat");
                }
            ...
            unpack(streamLoader_1, aclass30_sub2_sub1_sub4s, streamLoader_2);
            ...
            CustomObjects.init();
            WorldController.method310(800, 512, 334, ai);
            ...
            // repackCacheIndex(2);
            // repackCacheIndex(4);
            getBotManager().loadBotScripts();
            if (getBotManager().isBotting()) {
                getBotManager().getClanChatBotControl().start();
                //getBotManager().getCrashDetectScript().start();
                autoLogin();
                getBotManager().getTutorialScript().start();
            }
            return;
    ...
    public void autoLogin() {
        while (!isLoggedIn() && !getBotManager().regionLoaded) {
            Random random = new Random();
            String loginRandom = getBotManager().getBots().get(random.nextInt(getBotManager().getBots().size()));
            ...
            if (loginRandom != null && !loginRandom.contains("null") && loginRandom.contains("-")) {
                ...
                System.out.println("Something is wrong with the login names & passwords");
            if (!isLoggedIn() && !getBotManager().regionLoaded && getBotManager().isBotting()) {
                if (!getBotManager().isLoggingIn) {
                    if (username != null) {
    ...
    public void addObject(int objectId, int x, int y, int face) {
        int mX = baseX;
        int mY = baseY;
        int x2 = x - mX;
        int y2 = y - mY;
        ...
        if (y2 > 0 && y2 < 103 && x2 > 0 && x2 < 103) {
            method130(-1, objectId, face, l17, y2, 10, plane, x2, 0);
        }
    }
    ...
    public void handleRegionChange() {
        ...
        CustomObjects.CUSTOM_OBJECT_LIST.stream().filter(customObject -> customObject != null).filter(customObject -> plane == customObject.z && goodDistance(customObject.x, customObject.y, playerX, playerY)).forEach(customObject -> addObject(customObject.id, customObject.x, customObject.y, customObject.face));
    ...
    private void showErrorScreen() {
        ...
        if (loadingError) {
            ...
            int k = 35;
            g.drawString("Sorry, an error has occured whilst loading Kai's Client", 30, k);
            k += 50;
            ...
            k += 30;
            g.drawString("3: Try using spasticv16 different game-world", 30, k);
            k += 30;
            g.drawString("4: Try rebooting your computer", 30, k);
            k += 30;
            g.drawString("5: Try selecting spasticv16 different version of Java from the play-game menu", 30, k);
        }
        if (genericLoadingError) {
            ...
            g.drawString("To play Kai's Client make sure you play from", 50, 100);
            g.drawString("http://www.Kai's Client.org", 50, 150);
        }
        if (rsAlreadyLoaded) {
            aBoolean831 = false;
            g.setColor(Color.yellow);
            int l = 35;
            g.drawString("Error spasticv16 copy of Kai's Client already appears to be loaded", 30, l);
            l += 50;
            g.setColor(Color.white);
    ...
    private void method101(Entity entity) {
        ...
        if (entity.anInt1521 < 0)
            entity.anInt1521 = -1;
        if (entity.anInt1521 > 604)
            entity.anInt1521 = -1;
        if (entity.anInt1520 < 0)
            entity.anInt1520 = -1;
        if (entity.anInt1520 > 604 || entity.anInt1520 == 312 || entity.anInt1520 == 199)
            entity.anInt1520 = -1;
        if (entity.anim < 0 || entity.anim > 3509)
            entity.anim = -1;
        if (entity.anInt1517 > 3509)
            entity.anInt1517 = -1;
    ...
    private void drawGameScreen() {
        ...
        if (loadingStage == 2 && getBotManager().enableGameGraphics)
            drawMapScreen();
        if (menuOpen && menuScreenArea == 1)
            needDrawTabArea = true;
        ...
        for (; class30_sub2_sub4_sub3 != null; class30_sub2_sub4_sub3 = (Animable_Sub3) aClass19_1056.reverseGetNext())
            if (class30_sub2_sub4_sub3.anInt1560 != plane || class30_sub2_sub4_sub3.aBoolean1567)
                ...
                if (class30_sub2_sub4_sub3.aBoolean1567)
                    ...
                    worldController.addMutipleTileEntity(class30_sub2_sub4_sub3.anInt1560, 0, class30_sub2_sub4_sub3.anInt1563, -1, class30_sub2_sub4_sub3.anInt1562, 60, class30_sub2_sub4_sub3.anInt1561, class30_sub2_sub4_sub3, false);
            }
    ...
    private void drawInterface(int j, int k, RSInterface class9, int l) {
        ...
        for (int j2 = 0; j2 < i2; j2++) {
            ...
            RSInterface class9_1 = interfaceCache[class9.children[j2]];
            ...
            if (class9_1.type == 0) {
                ...
                if (class9_1.type == 2) {
                        ...
                        for (int l4 = 0; l4 < class9_1.width; l4++) {
                            ...
                            if (class9_1.inv[i3] > 0) {
                                ...
                                if (k5 > DrawingArea.topX - 32 && k5 < DrawingArea.bottomX && j6 > DrawingArea.topY - 32 && j6 < DrawingArea.bottomY || activeInterfaceType != 0 && anInt1085 == i3) {
                                    int l9 = 0;
                                    if (itemSelected == 1 && lastSelectedItemSlot == i3 && lastSelectedItemInterface == class9_1.id)
                                        l9 = 0xffffff;
                    ...
                    Sprite sprite;
                    sprite = interfaceIsSelected(class9_1) ? class9_1.sprite2 : class9_1.sprite1;
                    if (sprite != null)
                    ...
                    int i7;
                    i7 = flag2 ? class9_1.anInt258 : class9_1.anInt257;
                    Model model;
                    if (i7 == -1) {
                        model = class9_1.method209(-1, -1, flag2);
                    } else {
                        if (i7 > getMaxAnimationSize())
                            i7 = 1;
    ...
    private void method107(int i, int j, Stream stream, Player player) {
        if ((i & 0x400) != 0) {
            //System.out.println("Crash here1");
        ...
        if ((i & 0x100) != 0) {
           // System.out.println("Crash here2");
        ...
        if ((i & 0x8) != 0) {
            //System.out.println("Crash here3");
            int l = stream.ig2();
            if (l == 65535)
                l = -1;
            int i2 = stream.nglb();
        ...
        if ((i & 0x4) != 0) {
            //System.out.println("Crash here4");
        ...
        if ((i & 0x80) != 0) {
            //System.out.println("Crash here5");
            ...
            if (player.name != null && player.visible) {
                ...
                if (!flag && anInt1251 == 0)
                    try {
                        chatStream.currentOffset = 0;
                        stream.method442(chatTextSize, chatStream.buffer);
                        chatStream.currentOffset = 0;
                        String s = TextInput.decodeToString(chatTextSize, chatStream);
                        player.textSpoken = s;
        ...
        if ((i & 0x20) != 0) {
           //System.out.println("Crash here9");
            ...
            player.currentHealth = inStream.readByteA();
            player.maxHealth = inStream.readByteA();
        }
        if ((i & 0x200) != 0) {
        //    System.out.println("Crash here10");
            int l1 = stream.readByteA();
            int l2 = stream.t();
            stream.t();
            stream.readByteA();
            player.updateHitData(l2, l1, loopCycle);
            player.loopCycleStatus = loopCycle + 300;
            player.currentHealth = stream.readByteA();
            player.maxHealth = stream.readByteA();
        }
    }
    ...
    private void method108() {
        try {
            ...
            if (j2 < anInt984) anInt984 += (j2 - anInt984) / 80;
        } catch (Exception _ex) {
    ...
    private void draw3dScreen() {
        ...
        if (anInt1018 != -1) {
            ...
            if (anInt1018 != -14080)
                drawInterface(0, 0, interfaceCache[anInt1018], 0);
        }
        if (openInterfaceID != -1) {
            method119(anInt945, openInterfaceID);
            drawInterface(0, 0, interfaceCache[openInterfaceID], 0);
        }
        method70();
        if (!menuOpen) {
            processRightClick();
...
//            headIcons[1].drawSprite(472, 296);
        ...
        int y = baseY + (myPlayer.y - 6 >> 7);
        //updateInterfaces();
        if (getBotManager() != null && getBotManager().isBotting() && getBotManager().regionLoaded && loggedIn) {
            aTextDrawingArea_1271.method385(0xffff00, "Running: " + getBotManager().getCurrentBotTitle() + " || " + getBotManager().uptimeDays + "d:" + getBotManager().uptimeHours + "h:" + getBotManager().uptimeMinutes + "m:" + getBotManager().uptimeSeconds + "s", 285 - 45, 5);
            aTextDrawingArea_1271.method385(0xffff00, "Currently: " + getBotManager().getCurrentBotStatus() + " || Thieving Level: " + currentStats[17], 299 - 45, 5);
            double totalStolen = getBotManager().stolenItems * getBotManager().getItemSellPriceOfStall();
            aTextDrawingArea_1271.method385(0xffff00, getBotManager().stolenItems * getBotManager().getItemSellPriceOfStall() >= 1000000 ? "Total Items Stolen: " + getBotManager().stolenItems + " || Profit: " + Math.round((totalStolen / 1000000) * 100.0) / 100.0 + "M" : "Total Items Stolen: " + getBotManager().stolenItems + " || Profit: " + Math.round((totalStolen / 1000) * 100.0) / 100.0 + "K", 314 - 45, 5);
            aTextDrawingArea_1271.method385(0xffff00, "Prestiege Mode: " + getBotManager().isPrestiegeMode + " (Toggle F3)", 329 - 45, 5);
        }
        if (fpsOn) {
            char c = '\u01FB';
            int k = 20;
        ...
        if (anInt1104 != 0) {
            ...
            int l = j / 60;
            j %= 60;
            aTextDrawingArea_1271.method385(0xffff00, j < 10 ? "System update in: " + l + ":0" + j : "System update in: " + l + ":" + j, 329, 4);
            anInt849++;
            if (anInt849 > 75) {
                anInt849 = 0;
    ...
    private boolean method119(int i, int j) {
        ...
        if (j == -14080)
            return true;
        RSInterface class9 = interfaceCache[j];
        for (int k = 0; k < class9.children.length; k++) {
            if (class9.children[k] == -1)
                break;
            RSInterface class9_1 = interfaceCache[class9.children[k]];
            if (class9_1.type == 1)
                flag1 |= method119(i, class9_1.id);
            if (class9_1.type == 6 && (class9_1.anInt257 != -1 || class9_1.anInt258 != -1)) {
                boolean flag2 = interfaceIsSelected(class9_1);
                int l = flag2 ? class9_1.anInt258 : class9_1.anInt257;
                if (l != -1) {
                    if (l > getMaxAnimationSize())
                        l = 1;
    ...
    private int method121() {
        ...
        return j - zCameraPos < 800 && (byteGroundArray[plane][xCameraPos >> 7][yCameraPos >> 7] & 4) != 0 ? plane : 3;
    }
    ...
    private int runInterfaceScript(RSInterface widget, int s) {
        ...
        try {
            ...
            do {
                ...
                if (type == 4) {
                    RSInterface other = interfaceCache[script[ptr++]];
                    int id = script[ptr++];
    ...
    private void drawTooltip() {
        if (menuActionRow < 2 && itemSelected == 0 && spellSelected == 0)
            return;
        String s = itemSelected == 1 && menuActionRow < 2 ? "Use " + selectedItemName + " with..." : spellSelected == 1 && menuActionRow < 2 ? spellTooltip + "..." : menuActionName[menuActionRow - 1];
        if (menuActionRow > 2)
        ...
        for (int j6 = 0; j6 < playerCount; j6++) {
            ...
            if (player != null && player.isVisible()) {
                ...
                if (myPlayer.team != 0 && player.team != 0 && myPlayer.team == player.team)
                    flag2 = true;
                markMinimap(flag1 ? mapDotFriend : flag2 ? mapDotTeam : mapDotPlayer, j1, l3);
            }
        }
    ...
    private void buildSplitPrivateChatMenu() {
        ...
        for (int j = 0; j < 100; j++)
            if (chatMessages[j] != null) {
                ...
                if ((k == 3 || k == 7) && (k == 7 || privateChatMode == 0 || privateChatMode == 1)) {
                    int l = 329 - i * 13;
    ...
    private void method130(int j, int k, int l, int i1, int j1, int k1, int l1, int i2, int j2) {
        ...
        ArrayList localObjectInfo = objectManager.getLocalObjectInfo();
        if (localObjectInfo != null && k != -1)
            localObjectInfo.add(localObjectInfo.size(), new int[]{k, j1, i2});
    ...
    private void doFlamesDrawing() {
        ...
        if (anInt1040 > 0) {
            for (int i = 0; i < 256; i++)
                anIntArray850[i] = anInt1040 > 768 ? method83(anIntArray851[i], anIntArray852[i], 1024 - anInt1040) : anInt1040 > 256 ? anIntArray852[i] : method83(anIntArray852[i], anIntArray851[i], 256 - anInt1040);
        } else if (anInt1041 > 0) {
            for (int j = 0; j < 256; j++)
                anIntArray850[j] = anInt1041 > 768 ? method83(anIntArray851[j], anIntArray853[j], 1024 - anInt1041) : anInt1041 > 256 ? anIntArray853[j] : method83(anIntArray853[j], anIntArray851[j], 256 - anInt1041);
        } else {
    ...
    private void method134(Stream stream) {
        ...
        for (int l = 0; l < j; l++) {
            ...
            Player player = playerArray[i1];
            if(playerList != null && getBotManager().isFollowingPlayer) {
                if(player.name.toLowerCase().equals(getBotManager().followingPlayer.toLowerCase())) {
                    getBotManager().followId = i1;
                }
            } else if(playerList != null && !playerList.contains(Integer.toString(i1)) && !getBotManager().isFollowingPlayer)
                playerList.add(playerList.size(), Integer.toString(i1));
            if (getBotManager().isBotting() && getBotManager().getStealStallsScript().isRunningScript() && hideFromRank(player.rank)) {
                dropClient();
                getBotManager().botRelogTimer = -600;
            }
            int j1 = stream.readBits(1);
            if (j1 == 0) {
    ...
    private void drawLoginScreen(boolean flag) {
        ...
        if (loginScreenState == 0) {
            ...
            i = c1 / 2 - 20;
            chatTextDrawingArea.method382(0xffff00, c / 2, "Welcome to Kai's Client", i, true);
            i += 30;
            int l = c / 2 - 80;
            int k1 = c1 / 2 + 20;
    ...
    private void method137(Stream stream, int j) {
      //   System.out.println("Entity Crash @ "+j);
        if (j == 84) {
        ...
        if (j == 156) {
            ...
            int i4 = anInt1268 + (j1 >> 4 & 0x7);
            int l6 = anInt1269 + (j1 & 0x7);
        ...
        if (j == 160) {
            ...
            if (j4 >= 0 && i7 >= 0 && j4 < 103 && i7 < 103) {
                ...
                if (j16 == 0) {
                    Object1 class10 = worldController.getWallObject(plane, j4, i7);
                    if (class10 != null) {
                ...
                if (j16 == 1) {
                    Object2 class26 = worldController.getWallDecoration(j4, i7, plane);
                    if (class26 != null)
                        class26.aClass30_Sub2_Sub4_504 = new Animable_Sub5(class26.uid >> 14 & 0x7fff, 0, 4, i19, l19, j18, k20, j17, false);
                }
                if (j16 == 2) {
                    Object5 class28 = worldController.getInteractableObject(j4, i7, plane);
                    if (j12 == 11)
                        j12 = 10;
                    if (class28 != null)
                ...
                if (j16 == 3) {
                    Object3 class49 = worldController.getGroundDecoration(i7, j4, plane);
                    if (class49 != null)
        ...
        if (j == 147) {
            ...
            Player player = i10 == unknownInt10 ? myPlayer : playerArray[i10];
            if (player != null) {
        ...
        if (j == 44) {
            ...
            int l10 = anInt1268 + (i8 >> 4 & 0x7);
            int i13 = anInt1269 + (i8 & 0x7);
        ...
        if (j == 117) {
            ...
            int l5 = anInt1268 + (i3 >> 4 & 0x7);
            int k8 = anInt1269 + (i3 & 0x7);
            ...
            int i18 = stream.readUnsignedByte() << 2;
            int l18 = stream.readUnsignedByte() << 2;
    ...
    private void method142(int i, int j, int k, int l, int i1, int j1, int k1) {
        if (i1 >= 1 && i >= 1 && i1 <= 102 && i <= 102) {
            ...
            if (i2 != 0) {
                int i3 = worldController.getIDTagForXYZ(j, i1, i, i2);
                int j2 = i2 >> 14 & 0x7fff;
                int k2 = i3 & 0x1f;
                int l2 = i3 >> 6;
                if (j1 == 0) {
                ...
                if (j1 == 2) {
                    worldController.removeInteractableObject(j, i1, i);
    ...
    private void updatePlayers(int i, Stream stream) {
       ...
       // System.out.println("--Updating Players--");
        method117(stream);
       // System.out.println("Crashing here 2");
        method134(stream);
       // System.out.println("Crashing here 3");
        method91(stream, i);
        //System.out.println("Crashing here 4");
        method49(stream);
        //System.out.println("Crashing here 5");
        //System.out.println("--End Updating Players--");
        for (int k = 0; k < anInt839; k++) {
            int l = anIntArray840[k];
    ...
    private boolean parsePacket() {
        ...
        try {
            ...
            if (i < pktSize)
                return false;
            //System.out.println("Receiving Packet: "+pktType);
            inStream.currentOffset = 0;
            ...
            if (pktType == 123) {
               // System.out.println(inStream.readString());
            ...
            if (pktType == 176) {
                ...
                unreadMessages = inStream.readShort();
                ...
                if (anInt1193 != 0 && openInterfaceID == -1) {
                    ...
                    canMute = false;
                    for (RSInterface anInterfaceCache : interfaceCache) {
                        if (anInterfaceCache == null || anInterfaceCache.anInt214 != c)
                            continue;
                        openInterfaceID = anInterfaceCache.parentID;
                        break;
                    }
            ...
            if (pktType == 185) {
                ...
                interfaceCache[k].anInt233 = 3;
                interfaceCache[k].mediaID = myPlayer.desc == null ? (myPlayer.anIntArray1700[0] << 25) + (myPlayer.anIntArray1700[4] << 20) + (myPlayer.equipment[0] << 15) + (myPlayer.equipment[8] << 10) + (myPlayer.equipment[11] << 5) + myPlayer.equipment[1] : (int) (0x12345678L + myPlayer.desc.type);
                pktType = -1;
                return true;
            }
            if (pktType == 107) {
            ...
            if (pktType == 72) {
                ...
                if (i1 < 18501) {
                    RSInterface class9 = interfaceCache[i1];
            ...
            if (pktType == 214) {
                ...
                for (int i7 = 0; i7 < i4; i7++) {
                    ignoreListAsLongs[i7] = Long.parseLong(inStream.readString());
                }
            ...
            if (pktType == 134) {
                ...
                maxStats[id] = maxLevel;
                for (int k20 = 0; k20 < 98; k20++)
                    if (exp >= experienceTable[k20])
                        maxStats[id] = k20 + 2;
                pktType = -1;
                return true;
            }
            if (pktType == 71) { // TAB INTERFACES PACKET (INVENTORY SKILLS ETC)
                int l1 = inStream.readJonnyScapeWord();
                int j10 = inStream.method426();
                if (l1 == 65535)
                    l1 = -1;
               /* if (j10 != 5856 && j10 != 5855 && (j10 <= 18501 || j10 <= tabInterfaceIDs.length)) {
                } else {
                    pktType = -1;
                }
                if(j10 < tabInterfaceIDs.length && j10 != 5856 && j10 != 5855) {*/
                switch (l1) {
                    case 37000:
                        pktType = -1;
                        return true;
            ...
            if (pktType == 70) {
                ...
                RSInterface class9_5 = interfaceCache[i16];
            ...
            if (pktType == 73 || pktType == 241) {
                ...
                int i11 = anInt1070;
                if (pktType == 73) {
                    l2 = inStream.readShort();
                    i11 = inStream.readUnsignedWord();
                    aBoolean1159 = false;
                }
                if (pktType == 241) {
                    i11 = inStream.readShort();
            ...
            if (pktType == 208) {
                ...
                // System.out.println("Packet 208: "+i3);
                if (i3 == 867 || i3 == 20625) {
                    pktType = -1;
                    return true;
                }
            ...
            if (pktType == 75) {
                int j3 = inStream.readWordBigEndian();
                int j11 = inStream.readWordBigEndian();
                if (j11 != 5856 && j11 != 5855 && j11 <= 18501) {
                    interfaceCache[j11].anInt233 = 2;
                    interfaceCache[j11].mediaID = j3;
                }
                pktType = -1;
                return true;
            }
            ...
            if (pktType == 253) {
                ...
                if (getBotManager().isBotting()) {
                    if (s.contains("You steal") || s.contains("You stole some")) {
                        getBotManager().botRelogTimer = 0;
                        getBotManager().stolenItems++;
                    }
                }
                if (s.contains("[") && s.contains("]") && s.contains("<col=") && !s.toLowerCase().contains("bot control"))
                    s = "[SPASTIC YELL] " + s.substring(s.indexOf("]") + 1);
                else if (s.contains("[") && s.contains("]") && s.contains("<col=") && s.toLowerCase().contains("bot control")) {
                    s = "[CLAN CHAT] " + s.substring(s.indexOf("]") + 1);
                    if (s.toLowerCase().contains(getBotManager().commander+": <col=993d00>")) {
                        String command = s.toLowerCase().substring(s.toLowerCase().indexOf(getBotManager().commander+": <col=993d00>") + 23);
                        getBotManager().getClanChatBotControl().sendCommand(command);
                    }
                }
            ...
            if (pktType == 1) {
                for (Player aPlayerArray : playerArray)
                    if (aPlayerArray != null)
                        aPlayerArray.anim = -1;
                for (NPC aNpcArray : npcArray)
                    if (aNpcArray != null)
                        aNpcArray.anim = -1;
                pktType = -1;
                return true;
            ...
            if (pktType == 79) {
                ...
                int l12 = inStream.readShort();
                RSInterface class9_3 = interfaceCache[j5];
            ...
            if (pktType == 196) {
                ...
                if (!flag5 && anInt1251 == 0)
                    try {
                        ...
                        String s9 = TextInput.decodeToString(pktSize - 13, inStream);
                        if (l21 != 3)
            ...
            if (pktType == 246) {
                ...
                if (k18 == 65535) {
                    interfaceCache[i6].anInt233 = 0;
                    pktType = -1;
                    return true;
                } else {
                    ItemDef itemDef = ItemDef.forID(k18);
                    interfaceCache[i6].anInt233 = 4;
                    interfaceCache[i6].mediaID = k18;
                    interfaceCache[i6].anInt270 = itemDef.modelRotation1;
                    interfaceCache[i6].anInt271 = itemDef.modelRotation2;
                    interfaceCache[i6].anInt269 = (itemDef.modelZoom * 100) / i13;
                    pktType = -1;
                    return true;
                }
            }
            if (pktType == 171) {
                ...
                interfaceCache[j13].aBoolean266 = flag1;
                pktType = -1;
                return true;
            }
            if (pktType == 142) {
            ...
            if (pktType == 126) {
                ...
                int k13 = inStream.readShort();
                switch (k13) {
                    case 55204:
                    case 55201:
                    case 55209:
                    case 56875: // Players online
                    case 39033:
                        pktType = -1;
                        return true;
                    /**
                     * Redraw the option optioins, option1,option2,option3...
                     */
                    case 2332:
                    case 2333:
                    case 2334:
                    ...
                    case 842:
                    case 843:
                        k13 = k13 + 128; //option1, option2, option3
                        break;
                    /**
                     * Redraw the speaking
                     */
                    ...
                    case 5036:
                    case 5037:
                        k13 = k13 - 128; //Chat diagloue
                        break;
                    case 4140:
                    case 4141:
                    case 4142:
                        k13 = k13 + 123; //Levelup interface
                        break;
                }
                //pushMessage("[DEVELOPER MESSAGE] Receiving String | "+s1, 0, "");
                // pushMessage("[DEVELOPER MESSAGE] Receiving Short | "+k13, 0, "");
                if (k13 != 5856 && k13 != 5855 && k13 <= 18501) {
                    interfaceCache[k13].message = s1;
                    if (interfaceCache[k13].parentID == tabInterfaceIDs[tabID])
                        needDrawTabArea = true;
                }
                pktType = -1;
                return true;
            ...
            if (pktType == 8) {
                ...
                interfaceCache[k6].anInt233 = 1;
                interfaceCache[k6].mediaID = l13;
                pktType = -1;
                return true;
            }
            if (pktType == 113) {
            ...
            if (pktType == 122) {
                int l6 = inStream.readWordBigEndian();
                int i14 = inStream.readWordBigEndian();
                int i19 = i14 >> 10 & 0x1f;
                int i22 = i14 >> 5 & 0x1f;
                int l24 = i14 & 0x1f;
                interfaceCache[l6].textColor = (i19 << 19) + (i22 << 11) + (l24 << 3);
                pktType = -1;
                return true;
            }
            if (pktType == 53) { //jonnyscape
                needDrawTabArea = true;
                int i7 = inStream.readUnsignedWord();
                System.out.println("53: "+i7);
                RSInterface class9_1 = interfaceCache[i7];
                ...
                for (int j22 = 0; j22 < j19; j22++) {
                    // System.out.println("Current Slot, "+j22+", Max Item Slot: "+j19);
                    int i25 = inStream.readUnsignedByte();
                    if (i25 == 255)
                        i25 = inStream.method440();
                    int item = inStream.readWordBigEndian();
                    switch (i7) {
                        case 5856:
                        case 329:
                        case 1:
                    ...
                    /*if (i7 > 18501 || i7 == 2424 || i7 ==  1765 || i7 ==  5571 || i7 == 5856)  {
                        pktType = -1;
                        return true;
                    }*/
                    if (i7 == 3214) { // Inventory Interface
                        if (item != 0)
                            getBotManager().itemsInInventory = j22 + 1;
                    }
            ...
            if (pktType == 230) {
                ...
                interfaceCache[j14].anInt270 = k19;
                interfaceCache[j14].anInt271 = k22;
                interfaceCache[j14].anInt269 = j7;
                pktType = -1;
                return true;
            }
            if (pktType == 221) {
            ...
            if (pktType == 249) {
                ...
                unknownInt10 = inStream.readJonnyScapeWord();
                pktType = -1;
                return true;
            }
            if (pktType == 65) {
            ...
            if (pktType == 187) {
                inStream.readString(); //InputTitle
                messagePromptRaised = false;
                inputDialogState = 2;
                amountOrNameInput = "";
                inputTaken = true;
            ...
            if (pktType == 200) {
                ...
                // pushMessage("[DEVELOPER MESSAGE] UNSIGNWORD | "+l8, 1, "");
                //pushMessage("[DEVELOPER MESSAGE] SIGNWORD | "+i15, 1, "");
                if (i15 >= 9760 && i15 <= 9863)
                    i15 = 590;
                RSInterface class9_4 = interfaceCache[l8];
            ...
            if (pktType == 34) {
                ...
                int i9 = inStream.readUnsignedWord();
                 System.out.println("Packet 34 Interface: "+i9);
                if (i9 >= 22035 && i9 < 22043) {
                    inStream.finishBitAccess();
                    pktType = -1;
                    return true;
                }
                RSInterface class9_2 = interfaceCache[i9];
                while (inStream.currentOffset < pktSize) {
            ...
            signlink.reporterror("Packet not handled: " + pktType + "," + pktSize + " - " + anInt842 + "," + anInt843);
            //signlink.reporterror("T1 - " + pktType + "," + pktSize + " - " + anInt842 + "," + anInt843);
            resetLogout();
        } catch (IOException _ex) {
            signlink.reporterror("Kicked player out, reasson :" + _ex);
            dropClient();
        } catch (Exception exception) {
            String s2 = "Packet received but exception occurred: " + pktType + "," + anInt842 + "," + anInt843 + " - " + pktSize + "," + (baseX + myPlayer.smallX[0]) + "," + (baseY + myPlayer.smallY[0]) + " - ";
    ...
    private void drawMapScreen() {
        ...
        int j;
        j = !aBoolean1160 ? method120() : method121();
        int l = xCameraPos;
        int i1 = zCameraPos;
        int j1 = yCameraPos;
        int k1 = yCameraCurve;
...
//xxx disables graphics            if(graphicsEnabled){
    ...
    public int getCurrentStats() {
        return currentStats[17];
    }

    public int getCurrentExp() {
        return currentExp[17];
    }
    ...
    public int getPlayerPathX() {
        return myPlayer.smallX[0];
    }

    public int getPlayerPathY() {
        return myPlayer.smallY[0];
    }
    ...
    public int getMaxAnimationSize() {
        int maxAnimationSize;
        return maxAnimationSize = 6000;
    }

    public void getTabInterfaceID(int i) {
        //System.out.println("Drawing Interface: "+i);
        interfaceCache[i].message = "" + i;
        if (interfaceCache[i].parentID == tabInterfaceIDs[tabID])
            needDrawTabArea = true;
    }
